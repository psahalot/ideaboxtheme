...
class Tribe_Image_Widget extends WP_Widget {
	...
	function admin_setup() {
		wp_enqueue_media();
		wp_enqueue_script( 'tribe-image-widget', trailingslashit( get_template_directory_uri() ) . '/inc/widgets/image-widget/resources/js/image-widget.js', array( 'jquery', 'media-upload', 'media-views' ), self::VERSION );
